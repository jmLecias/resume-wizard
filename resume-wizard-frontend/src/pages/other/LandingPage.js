...
import landingpagebg from '../../components/images/landingpagebg.jpg'

const LandingPage = () => {
    return (
        <div className='user-main' style={{ backgroundImage: `url(${landingpagebg})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
